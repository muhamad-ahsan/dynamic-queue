...
{
    /// <summary>
    /// ZeroMq based in-process implementation of IOutboundFaFMq.
    /// </summary>
    internal sealed class ZmqIpOutboundFaF<TMessage> : BaseZeroMq, IOutboundFaFMq<TMessage>
    {
        ...
        #region Constructors
        public ZmqIpOutboundFaF(Dictionary<string, string> configuration, IQueueLogger loggerObject)
        {
            try
            {
                #region Initialization
                base.Initialize(configuration, ZeroMqSocketType.Pair, false, loggerObject);
