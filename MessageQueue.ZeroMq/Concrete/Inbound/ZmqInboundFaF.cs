...
{
    /// <summary>
    /// ZeroMq based implementation of IInboundFaFMq.
    /// </summary>
    internal sealed class ZmqInboundFaF<TMessage> : BaseZeroMq, IInboundFaFMq<TMessage>
    {
        ...
        #region Constructors
        public ZmqInboundFaF(Dictionary<string, string> configuration, IQueueLogger loggerObject)
        {
            try
            {
                #region Initialization
                base.Initialize(configuration, ZeroMqSocketType.Pull, true, loggerObject);
